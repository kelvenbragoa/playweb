...
const getData = (page=1) => {
  axios.get(`/owner-recharges/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
       ...
       .then((response)=>{
        ...
        retrievedData.value = response.data.recharge;
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Nome da Preço: {{ retrievedData.user.name }}</p>
                                                    <p>Valor: {{ retrievedData.price }} MT</p>
                                                    <p>Ref: {{ retrievedData.ref }}</p>

                                                    <p>Método: {{ retrievedData.method }}</p>
